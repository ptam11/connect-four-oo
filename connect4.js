...
class Game {
  constructor(height, width){
    ...
    // startButton.addEventListener("click", makeBoard().bind(this));
    // startButton.addEventListener("click", makeHTMLBoard().bind(this));
  };
 ...
 */
  makeBoard() {
    // let startButton = document.getElementById("start-button");
    // startButton.addEventListener("click", let run  {
